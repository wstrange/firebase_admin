...
class CollectionReferenceImpl implements CollectionReference {
  ...
  CollectionReferenceImpl(this.client,this._path):api = FirestoreApi(client);
  ...
  DocumentReference get parent => throw UnimplementedError();


}
@immutable
// class CollectionReference implements Query {
abstract class CollectionReference {
  ...
  DocumentReference get parent => throw 'not done';
